...
<?php 
  ...
  <form name="form6" id="ff6" method="POST" action="<?php include 'luudonhang.php'?>">
	<div id="page-content" class="single-page">
			...
			<div class="row">
				<div class="col-lg-12">
					<ul class="breadcrumb">
						...
						<li><a style="text-align:center">Order confirmation</a></li>
					</ul>
				</div>
			</div>
		...
		<div class="col-lg-5">
		<div class="panel panel-default">
			<div class="panel-heading">Information line</div>
             <div class="panel-body">		 
			 <div class="col-md-12">
  ...
  <table class="table">
    <thead>
      <tr>
		...
		<th></th>
		<th></th>
		<th  name="result"  style="color:red"><strong style="color:red" id="result" name="total"><?php echo  $total    ?>$</strong></th>  
