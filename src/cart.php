	...
	<div id="page-content" class="single-page">
		<div class="container">
			...
			$ok=1;
			 ...
			 if($ok == 2)
			 {
				echo "".count($_SESSION['cart']). " There is a toy in the cart. ";
			 }
			else
			{
				echo   "<p>There are no toys in the cart</p>";
			}
					...
					<div class="col-md-9">
						<div class="caption">
							...
							<?php
								 ...
								 {                                      
								?>
								<div class="price"><?php  echo $s["giakhuyenmai"]?>$</div>
								<?php 
								}
								?>
								<?php
								 ...
								 {
								?>
								<div class="price"><?php  echo $s["Gia"]?>$</div>
								<?php 
								}
								?>
							...
							<input class="form-inline quantity" style="margin-right: 80px;width:50px" min="1" max ="99" type="number" name ="qty[<?php echo $s["ID"] ?>]" value="<?php echo $_SESSION['cart'][$s["ID"]]?>"> 
						     <div>
								<input type="submit" name="update" style="margin-top:31px"  value="UpdateToy" class="btn btn-2" />
							</div>
							<hr>
							<input type="submit" name="remove" value="DeleteToy" class="btn btn-default pull-right" />	
							...
							<?php
							    ...
							    echo  $_SESSION['cart'][$s["ID"]] * $s["giakhuyenmai"]?>$  </label> 
								<?php 
								}
								?>
								<?php
								...
								?>
									<label style="color:red">Total: <?php ;
							    echo  $_SESSION['cart'][$s["ID"]] * $s["Gia"]?>$  </label> 
								<?php 
								}
								?>
			...
			<div class="row">
			<a href="rmcart.php" class="btn btn-2" style="margin-bottom:31px">Clear cart</a>
				<div class="col-md-4 col-md-offset-8 ">
					<center><a href="index.php" class="btn btn-1" style="margin-left:-76px">Choose other toys</a></center>
				</div>
			<div class="row">
