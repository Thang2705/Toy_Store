	...
	<div id="page-content" class="single-page">
		<div class="container">
			...
			$ok=1;
			 ...
			 if($ok == 2)
			 {
				echo "Có ".count($_SESSION['cart']). " There are toys in the cart";
			 }
			else
			{
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-8 ">
					...
					<center><p style="color:red"><i class="fa fa-exclamation" aria-hidden="true"> You need to login to order</i></p>
                    <a href="index.php" class="btn btn-1" style="margin-left:-76px">Choose other toys</a></center>
				</div>
			<div class="row">
				<div class="pricedetails">
					<div class="col-md-4 col-md-offset-8" >
						...
						<center>
                      <a href="account.php"  class="btn btn-1">Go to login page</a>
                      </center>
