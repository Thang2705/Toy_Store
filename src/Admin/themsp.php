              ...
              <div class="box box-info">
                ...
                <form class="form-horizontal" method="POST" action="<?php include 'xulyluasp.php' ?>" enctype="multipart/form-data">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">Trademark</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control"  name="thương hiệu" placeholder="Thương hiệu" required>
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <option selected="selected" value="3">Choose Category</option>
                     <?php
                  ...
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label" >Promotions</label>
                    <div class="col-sm-10">
                    <select class="form-control select2" style="width: 100%;" name="khuyenmai">
                    <option selected="selected" value="1">Has Promotions</option>
                    <option  value="0">No Promotions</option>
                    </select>
                    </div>
                    </div>
                    <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label" >Promotions Price</label>
                    <div class="col-sm-10">
